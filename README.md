...
<body>
    <nav class="navbar">
        <div class="navbar-container container">
            ...
            <h1 class="logo">Vybha Restaurant</h1>
        </div>
    </nav>
    ...
    <section id="about">
        <div class="about-wrapper container">
            <div class="about-text">
                ...
                <p>
                    fancy restaurants often have an elegant ambiance with carefully designed decor, soft lighting, and luxurious furnishings. High-quality cuisine: The food at fancy restaurants is typically of the highest quality, prepared with precision and using the freshest ingredients available.
                </p>
            </div>
            <div class="about-img">
